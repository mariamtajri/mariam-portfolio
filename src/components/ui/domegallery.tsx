...
const DEFAULT_IMAGES: ImageItem[] = [
    ...
    { src: MongoDB, alt: "Financial Modeling" },
    { src: ExpressJS, alt: "Express.js" },
    { src: Docker, alt: "Adobe Creative Suite" },
    { src: GraphQL, alt: "Market Research" },
    { src: Redis, alt: "Google Sheets" },
    { src: C, alt: "C" },
    { src: Flutter, alt: "Flutter" },
    { src: Dart, alt: "Dart" },
    { src: MaterialUI, alt: "Material UI" },
    { src: Electron, alt: "Canva" },
    { src: TensorFlow, alt: "TensorFlow" },
    { src: ThreeJS, alt: "Three.js" },
    { src: Vite, alt: "Vite" },
    { src: Vercel, alt: "Public Speaking" },
    { src: Bootstrap, alt: "Content Strategy" },
    ...
    { src: Postman, alt: "Social Media Marketing" },
    { src: CPP, alt: "C++" },
    { src: Npm, alt: "npm" },
